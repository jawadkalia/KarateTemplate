Feature: sample karate test script
  ...
  # The Background runs before each Scenario! All variables in Background are available to all Scenarios
  Background:

  # Getting the baseUrl global variable that is defined in karate-config.js file.
  # The url is a keyword. https://github.com/intuit/karate#url
  # Setting the url value using the baseUrl global variable. since it is in the Background section it is available to all scenarios
  * url baseUrl

  # Variables declared within scenario are scoped within the scenairo. therefore they can not be shared with other scenarios
